...
Messages.user_cert_missing = "No se ha encontrado un certificado " \
    "personal"
Config.instname = "Universitat de València"
Config.profilename = "Alumnos"
Config.url = " \
    ""http://www.uv.es/uvweb/servei-informatica/es/atencio-usuaris/es/atencio-alumnat/es-sia-1285895808550.html"
Config.email = "tu soporte local eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "radius.uv.es"
...
Config.user_realm = "alumni.uv.es"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.uv.es']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

YuXRsS+lXqCZlNHLgUxk4ONTierU91YvxRIr6m6NbH65kQAx
-----END CERTIFICATE-----
"""
run_installer()
